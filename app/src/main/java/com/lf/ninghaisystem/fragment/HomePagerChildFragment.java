...
import com.lf.ninghaisystem.activities.ChildProjectActivity;
    ...
    public void initViews(View rootView) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (projectList.get(i).getHasSubProject() == 0) {
                    ...
                    Intent intent = new Intent(getActivity(), ChildProjectActivity.class);
                    intent.putExtra("isOwn",projectList.get(i).getIsOwn());
                    intent.putExtra("project", projectList.get(i));
                    getActivity().startActivity(intent);
                }
